...
import { Start } from './features/model/pages/start/start';
import { PageWelcome } from './features/model/pages/page-welcome/page-welcome';
export const routes: Routes = [
  ...
  // 👤 CLIENTE (logueado)
  {
    ...
    children: [
      ...
      { path: 'new-project', component: PageWelcome  },
      //{ path: 'new-project/start', component: Start },
